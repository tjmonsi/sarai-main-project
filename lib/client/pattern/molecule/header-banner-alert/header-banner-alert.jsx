...
export default class HeaderBannerAlert extends React.Component {
  componentDidMount() {
      ...
      <div className = "mdl-grid header-banner-alert">
        <div className = "mdl-cell mdl-cell--12-col header-banner-alert-title">
          <div className = "mdl-grid mdl-grid--no-spacing">
            <div className = "mdl-cell mdl-cell--1-col header-banner-alert-title-thumbnail-container">
              <img
                className = "header-banner-alert-title-thumbnail"
                src={this.props.headerBannerAlertTitleThumbnail}
              />
            </div>
            <div className = "mdl-cell mdl-cell--10-col header-banner-alert-title-text-container">
